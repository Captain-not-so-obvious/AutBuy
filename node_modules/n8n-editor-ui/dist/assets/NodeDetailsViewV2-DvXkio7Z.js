import { d as defineComponent, x as computed, c as useI18n, h as createElementBlock, g as openBlock, j as createBaseVNode, i as createVNode, n as normalizeClass, e as createBlock, f as createCommentVNode, bP as _sfc_main$3, as as InlineRename, l as unref, a1 as N8nLink, w as withCtx, p as N8nText, k as createTextVNode, t as toDisplayString, N as N8nIcon, $ as N8nTooltip, a0 as _sfc_main$4, _ as _export_sfc, r as ref, iE as LOCAL_STORAGE_NDV_PANEL_WIDTH, cX as toValue, cW as useElementSize, aa as watch, bT as toRef, eE as jsonParse, hB as Draggable, iF as FontAwesomeIcon, aM as useNDVStore, bB as useNodeHelpers, fy as storeToRefs, bz as usePinnedData, bG as useNodeTypesStore, T as useUIStore, a4 as useWorkflowsStore, v as useSettingsStore, dQ as useDeviceSupport, ar as useTemplateRef, dZ as getNodeOutputs, bo as NodeConnectionTypes, bH as START_NODE_TYPE, iu as EXECUTABLE_TRIGGER_NODE_TYPES, aQ as STICKY_NODE_TYPE, ap as EnterpriseEditionFeature, o as onMounted, gH as dataPinningEventBus, I as onBeforeUnmount, P as normalizeStyle, c9 as useStyles, e8 as getNodeIconSource, Q as createEventBus, c8 as N8nResizeWrapper, iv as APP_MODALS_ELEMENT_ID, cC as Teleport, ay as useTelemetry, aA as useMessage, aB as MODAL_CONFIRM, bd as useExternalHooks } from "./index-CAU8Zeff.js";
import { _ as __unplugin_components_0, T as TriggerPanel, I as InputPanel, O as OutputPanel } from "./TriggerPanel-C-0JCegt.js";
import { u as useNodeDocsUrl, N as NodeSettings } from "./NodeView-4YXAVrWh.js";
import { a as useKeybindings } from "./useKeybindings-0d48UFTt.js";
import { u as useWorkflowActivate } from "./useWorkflowActivate-C39vU0rW.js";
import "./RunData-B9jGswDT.js";
import "./FileSaver.min-BoHgd5iv.js";
import "./useExecutionHelpers-BIfEl-h7.js";
import "./RunDataParsedAiContent-B6Ss5mvl.js";
import "./InfoAccordion-KgxR9XUm.js";
import "./ActionDropdown-oe2q-18e.js";
import "./import-curl-jc1UtwMR.js";
import "./global-link-actions-BZz1vmQq.js";
import "./useExecutionDebugging-dVW9cpg5.js";
import "./useBeforeUnload-aOI6YxZR.js";
